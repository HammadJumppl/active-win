...
const {getBrowserUrl} = require('../build/Release/win_browser_url.node');
...
function windows() {
	...
	let url = null;
	if (processName && ['Google Chrome', 'Firefox', 'Microsoft Edge'].includes(processName)) {
		url = getBrowserUrl(activeWindowHandle.address(), processName);
	}
